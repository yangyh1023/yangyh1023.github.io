window.onload = function () {
    ...
    for (var i = 0; i < LinkCards.length; i++) {
            ...
            `<span class="LinkCard-content">
                <span class="LinkCard-text">
                    ...
                    <span class="LinkCard-meta">
                        ...
                        <a href="${link}" title="${link}" style="color:inherit;text-decoration:none;">${link}</a>
                    </span>
                </span>
        ...
        if (!logourl) {
            if (link.startsWith('http://localhost:4000/') || link.startsWith('https://youyeyejie.com/')) {
                var img = LinkCard.getElementsByClassName('LinkCard-image')[0];
                img.src = '/img/avatar/avatar.webp';
            }
            else {
                LinkCard.getElementsByClassName('LinkCard-imageCell')[0].style.display = 'none';
                LinkCard.getElementsByClassName('LinkCard-text')[0].style.maxWidth = 'calc(100% - 20px)'; 
            }
        }
    }
}